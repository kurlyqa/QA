...
from web_login import WebLogin
from order_history import OrderHistory
from order_transfer_management import OrderTransferManagement
from order_plan_management import OrderPlanManagement
...
s1 = TestLoader().loadTestsFromTestCase(WebLogin)
s2 = TestLoader().loadTestsFromTestCase(OrderHistory)
